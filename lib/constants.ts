export const aboutSection = {
  ...
  heading: 'About Me',
  shortBio:
    "I'm a software engineer dedicated to making software engineering enjoyable for everyone...",
  fullBio:
  ...
  skills: {
    ...
    activeText: (skill: string) =>
      `${skill}: Click to see projects using this skill!`,
  },
  interests: {
    heading: 'Interests',
    list: [
